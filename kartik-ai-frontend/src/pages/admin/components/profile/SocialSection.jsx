        ...
        {socials.map((social) => {
          ...
          return (
            <motion.div
              key={social.key}
              whileHover={{ y: -2 }}
              className="rounded-xl border border-white/10 bg-slate-900/40 p-3 transition hover:border-cyan-400/40"
            >
              ...
              <input
                ...
                value={formik.values.socials?.[social.key] || ""}
